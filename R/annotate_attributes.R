#' Title
#'
#' @param doc an EML metadata file
#' @param entity_num index of entity; see process_entites_by_type
#' @param dataTable_or_otherEntity a character string; "dataTable" or "otherEntity"
#' @param current_eml_entity the entity from doc at index 'enttity_num'
#' @param is_single_entity a boolean, TRUE or FALSE
#'
#' @return doc
#' @export
#'
